...
?>
                ...
                <h2><a href="#">Design</a> &raquo; <a href="#" class="active">Choose From pages below</a></h2>
  ...
  while ($content_row = mysql_fetch_array($result_content)){
	  ...
	  $name = $content_row['ContentName'];
		  ...
		  ?>
						<tr>
                                              <td>Page <? print $name ?> </td>
                                <td class="action"><a href="editcontent.php?id=<? print $contentid ?>">Edit</a><a href="deletecontent.php?id=<? print $contentid ?>" class="edit">Delete Page</a></td>
                            </tr>  
                            <?
