...
<br><br>
        ...
        <div id="content_holder">
                 ...
                 <form method="post" action="validate.php" class="smart-green">
                    ...
                    <input name="cost" type="hidden" value="<? echo $cost ?>">
                     <input name="order" type="hidden" value="<? echo $orderNumber ?>">
    ...
    <label>
        ...
        <input id="street" type="text" name="street" placeholder="Your Street Address"/>
    </label>
     <label>
        <span>Your City :</span>
	...
	<option value="ZWE">Zimbabwe</option>
     ...
     <label>
        ...
        <input id="postal" type="text" name="postal" placeholder="Your postal" />
    </label>
    <label>
        <span>Card Number :</span>
        <input id="card" type="text" name="card" placeholder="Card Number" />
    </label>     
                          <label>
    ...
    <option value='21'>2021</option>
                     ...
                     <label>
        <span>Security Number (3 digit on back of card) :</span>
        <input id="cvv" type="password" name="cvv" placeholder="CVV" />
    </label>   
   <label>
        <span><? echo $number1 ?> + <? echo $number2 ?> :</span>
        <input id="answer" type="answer" name="answer" placeholder="answer" />
    </label>
