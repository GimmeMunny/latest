...
//my SQL query strings
	$query_selectAllItems = "SELECT * FROM EmailTemplate WHERE EmailID = '1'";
...
?>
                ...
                <h2><a href="#">Email</a> &raquo; <a href="#" class="active">Edit Daily Email</a></h2>
                
                <div id="main">

	<form action="updatedaily.php" method="post">
		<h2>Edit the daily email below:</h2>
		<p>
			Subject:<br>
			<input type="text" name="subject" value="<? print $content['EmailSubject']?>"></p>
