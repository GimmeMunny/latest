...
$email=$_GET['email'];
$name=$_GET['name'];
$query_insertItem = "INSERT INTO Email (EmailAddress, Submitter) VALUES ('$email', '$name')";
$dberror = "";
...
<a href="index.php"><img src="images/logos.png" border="0"/></a>
 ...
 <div class="drop-shadow-white raised">
                <table width="100%"><tr><td><b>Tell a Friend:</b><br>

        <b>You have added <? print $email ?></b><br><br>
...
$subject = 'Welcome to GimmeMunny!';
$message = $name ." thinks you should play GimmeMunny.com too.  Win cash and prizes, the more that play the more we pay!\n";
 	//$email = ($row['Email']);
	$to      = $email;
