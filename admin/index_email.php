...
?>
                ...
                <h2><a href="#">Email</a> &raquo; <a href="#" class="active">Compose Email Blast</a></h2>
                
                <div id="main">

	<form action="sendemail.php" method="post">
		<h2>Build your email blast below:</h2>
		<p>
        Choose Database:<br>
        <?
  ...
  while ($row = mysql_fetch_array($result_order)){
	  $email=$row['EmailID'];
		...
		?>
			<select>
  <option value="investor" name="database">Investor Database - <? print $email ?> Records</option>
  ...
  while ($row2 = mysql_fetch_array($result_order2)){
	  $email2=$row2['EmailID'];
		...
		?>
<option value="player" name="database">Player Database - <? print $email2 ?> Records</option>
<?
  }
?>
</select></p>
