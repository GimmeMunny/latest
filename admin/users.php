...
?>
                ...
                <h2><a href="#">Users</a> &raquo; <a href="#" class="active">Choose From users below</a></h2>
  ...
  while ($content_row = mysql_fetch_array($result_content)){
      ...
      $contentid = $content_row['UserID'];
	  $name = $content_row['Username'];
		  $password = $content_row['Password'];
		  $email = $content_row['Email'];
		  
		  ?>
						<tr>
                                              <td>User: <? print $name ?> </td>
                                <td class="action"><a href="edituser.php?id=<? print $contentid ?>">Edit</a><a href="deleteuser.php?id=<? print $contentid ?>" class="edit">Delete User</a></td>
                            </tr>  
                            <?
  ...
  ?>
  	<tr>
                                              <td> </td>
                                <td class="action"><a href="adduser.php?id=<? print $contentid ?>">Add User</a></td>
                            </tr> 
